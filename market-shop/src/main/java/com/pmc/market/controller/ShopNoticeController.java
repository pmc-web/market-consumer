...
public class ShopNoticeController {
    ...
    public ResponseEntity<?> makeNotice(@ApiParam(value = "마켓 id") @PathVariable("shopId") long id, @RequestBody @Valid NoticeRequestDto noticeRequestDto) {
    ...
    public ResponseEntity<?> getNoticeDetail(@ApiParam(value = "마켓 id") @PathVariable("shopId") long shopId, @ApiParam(value = "공지사항 id") @PathVariable("noticeId") long noticeId) {
    ...
    public ResponseEntity<?> updateNotice(@ApiParam(value = "마켓 id") @PathVariable("shopId") long shopId, @ApiParam(value = "공지사항 id") @PathVariable("noticeId") long noticeId, @RequestBody @Valid NoticeRequestDto noticeRequestDto) {
    ...
    public ResponseEntity<?> deleteNotice(@ApiParam(value = "마켓 id") @PathVariable("shopId") long shopId, @ApiParam(value = "공지사항 id") @PathVariable("noticeId") long noticeId) {
