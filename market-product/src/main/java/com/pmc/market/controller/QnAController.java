...
public class QnAController {
    ...
    @PostMapping
    public ResponseEntity<?> writeQnA(@RequestBody QnARequestDto qnARequestDto) {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<?> updateQnA(@ApiParam("게시글 id") @PathVariable("id") long id, @RequestBody QnARequestDto qnARequestDto) {
    ...
    @GetMapping("/{id}")
    public ResponseEntity<?> getQnA(@ApiParam("게시글 id") @PathVariable("id") long id) {
